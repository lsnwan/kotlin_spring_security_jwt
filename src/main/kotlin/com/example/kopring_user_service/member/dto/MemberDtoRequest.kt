...
import com.example.kopring_user_service.common.annotation.ValidEnum
...
data class MemberDtoRequest(
  ...
  @field:NotBlank
  @field:ValidEnum(enumClass = Gender::class, message = "MAN 혹은 WOMAN 중 하나를 선택해주세요")
  @JsonProperty("gender")
